...
# Conclusion
The linear models with the most significance were .... However, when all models were compared, the best-performing one was aa vs pTM. Interestingly enough, it appears that on average, AlphaFold 2 structures aligned better with the x-ray diffraction structures and had a higher pTM as opposed to the newer AlphaFold 3. Moving forward, I would like to gather data for more proteins to increase the sample size, which would hopefully establish more concrete relationships and linear models. 
